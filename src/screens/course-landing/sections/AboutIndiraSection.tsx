      ...
      <section className="relative overflow-hidden bg-transparent px-4 py-10">
        ...
        <div className="relative z-10 mx-auto flex max-w-[360px] flex-col items-center">
          ...
          <div className="relative h-[400px] w-full">
            ...
            <div className="mt-6 absolute right-0 top-0 w-[205px] bg-[#f9e7b5]">
              ...
              <Image
                ...
                alt=""
                sizes="32px"
                className="pointer-events-none absolute -right-1 -top-2.5 z-10 h-8 w-8 rotate-[22deg] object-contain"
              />
            </div>
